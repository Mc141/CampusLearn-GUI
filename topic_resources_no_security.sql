-- ==============================================
-- TOPIC RESOURCES - NO SECURITY VERSION
-- ==============================================
...
-- DISABLE RLS completely - no security restrictions
ALTER TABLE topic_resources DISABLE ROW LEVEL SECURITY;

-- Drop all existing policies (they won't matter since RLS is disabled)
...
COMMENT ON TABLE topic_resources IS 'Learning resources uploaded for specific topics (NO SECURITY - PUBLIC ACCESS)';
